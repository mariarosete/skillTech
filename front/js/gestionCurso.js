document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('https://skilltech-api.onrender.com/cursos/buscarCursos', {
        method: 'GET',
        headers: {
    ...
    function eliminarCurso(idCurso) {
        fetch(`https://skilltech-api.onrender.com/cursos/eliminar/${idCurso}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('token') // Incluir el token JWT en el header de Authorization
    ...
    function mostrarFormularioEdicion(idCurso) {
        ...
        fetch(`https://skilltech-api.onrender.com/cursos/buscarCursos/${idCurso}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('token') // Incluir el token JWT en el header de Authorization
        ...
        document.querySelector('#formularioEdicion').addEventListener('submit', function(event) {
            ...
            fetch(`https://skilltech-api.onrender.com/cursos/modificar/${idCurso}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token') // Incluir el token JWT en el header de Authorization
