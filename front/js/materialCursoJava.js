        ...
        for (const material of data) {
            ...
            switch (nombre) {
                case "Introducción a Java":
                    materialsList = document.querySelector('#introduccion-java-materials-list');
                    break;
                case "Variables y tipos de datos en Java":
                    materialsList = document.querySelector('#variables-java-materials-list');
                    break;
                case "Estructuras de control en Java":
                    materialsList = document.querySelector('#estructuras-java-materials-list');
                    break;
                default:
