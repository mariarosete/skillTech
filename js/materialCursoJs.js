document.addEventListener('DOMContentLoaded', function () {
    ...
    .then(data => {
        ...
        for (const material of data) {
            ...
            let materialsList;
            switch (nombre) {
                case "Introducción a JavaScript":
                    materialsList = document.querySelector('#introduccion-js-materials-list');
                    break;
                case "Variables y tipos de datos":
                    materialsList = document.querySelector('#variables-js-materials-list');
                    break;
                case "Funciones y estructuras de control":
                    materialsList = document.querySelector('#funciones-js-materials-list');
                    break;
                default:
